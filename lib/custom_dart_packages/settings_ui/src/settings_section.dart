...
import 'package:wovie/custom_dart_packages/settings_ui/src/abstract_section.dart';
import 'package:wovie/custom_dart_packages/settings_ui/src/cupertino_settings_section.dart';
import 'package:wovie/custom_dart_packages/settings_ui/src/settings_tile.dart';
...
class SettingsSection extends AbstractSection {
  ...
  Widget androidSection(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (showBottomDivider) Divider(height: 1.w)
    ]);
  }
}
